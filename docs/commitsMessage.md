...
| `docs`    | Documentatie aanpassen (bijv. README.md) |
| `style`   | Code-opmaak verbeteren (bijv. spaties, linting, geen functionele wijziging) |
| `perf`    | Prestatieverbeteringen |
| `test`    | Tests toevoegen of aanpassen |
| `chore`   | Andere taken zoals build scripts of dependencies updaten |
| `ci`      | Aanpassingen in de CI/CD pipeline |
