...
public interface Transformer<E> {
     ...
     */
    void registerConstituency(Map<String, String> constituencyData, Map<Integer, Integer> affiliationVotes, Map<Integer, Integer> candidateVotes, Map<Integer, String> affiliationNames);
